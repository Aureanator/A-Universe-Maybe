...
**Reproduction.** All 12 P11 runs reproduce bit-for-bit in this tree (identical step counts, endpoints, audits; `reference/astra_session/data/scale_runs_reproduction_local.json`). Deterministic seeded streams make the whole campaign cross-checkout verifiable.
